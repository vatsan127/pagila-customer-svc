package dev.srivatsan.pagila_customer_svc.aop;
...
public class AspectService {
    ...
    private static final String POINTCUT_EXEC_FOR_ALL_SERVICE_METHODS = "execution(* dev.srivatsan.pagila_customer_svc.service.*.*(..))";
